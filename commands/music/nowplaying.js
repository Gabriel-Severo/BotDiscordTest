...
module.exports = class NowPlayingCommand extends Command {
    ...
    static playbackBar(message, video) {
        ...
        const timePassedInMSFormated =  NowPlayingCommand.formatDuration(timePassedInMSObj)

        const totalDurationObj = video.rawDuration
        const totalDurationFormated = NowPlayingCommand.formatDuration(totalDurationObj)
